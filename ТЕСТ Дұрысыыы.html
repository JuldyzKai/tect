...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, rgba(170, 176, 198, 0.8), rgba(231, 207, 207, 0.393), rgba(246, 223, 173, 0.8)),
                        url('Жібек пен Т.jpg') no-repeat center center fixed;
        ...
        .game-area {
            background-color: rgba(14, 10, 95, 0.921);
            border-radius: 15px;
            padding: 25px;
            flex-grow: 1;
            overflow-y: auto;
